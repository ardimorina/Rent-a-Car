    ...
    <div class="forma">
        ...
        <input type="hidden" id="perdoruesiid" name="perdoruesiid" 
            ...
            <div class="inputAndLabels">
                ...
                <input  readonly type="text" type="text" id="nrpersonal" name="nrpersonal"
                value="<?php if(!empty($nrpersonal)) echo $nrpersonal ?>">
            </div>
            <div class="inputAndLabels">
                <label for="telefoni">Nr telefonit</label> <br>
                <input  readonly type="text" type="text" id="telefoni" name="telefoni"
                value="<?php if(!empty($telefoni)) echo $telefoni ?>">
            </div>
            <div class="inputAndLabels">
                <label for="email">Email</label> <br>
                <input   readonly type="text" type="email" id="email" name="email"
